        ...
        <div className="introduce-container">
          <div className="introduce-box1">
            ...
            <div className='about-contents'>
              ...
              <p{...useScrollFadeIn('up', 1, 0.5)}>저는 코드스테이츠 부트캠프에서 팀원과의 <u>협업</u>, <u>코드리뷰</u> 등으로 <u>페어 프로그래밍</u> 기반 과제 진행과 2번의 협업 프로젝트를 진행했습니다.
              사용자 입장에서 개발하는 것을 지향하여 계속 고민하고 더 나은 방향에 대해 팀원들과 소통하는 것을 중요시합니다.</p>
              <p{...useScrollFadeIn('up', 1, 0.8)}>또한 자기 개발 및 계발을 좋아합니다. 늘 새로운 stack에 대한 호기심을 갖고 스터디를 하고 있습니다.
