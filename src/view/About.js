    ...
    <div className="About">
      <div className="about-inner">
        ...
        <div className="introduce-container">
          ...
          {/* <div> */}
            <div className="introduce2" {...useScrollAnimation()}>
            주니어 프론트엔드 개발자 <span>이재훈</span>입니다.
            </div>
          {/* </div> */}
          </p>
          <p>
            <div className="introduce3" {...useScrollAnimation()}>
            저는 코드스테이츠 부트캠프에서 팀원과의 <u>협업</u>, <u>코드리뷰</u> 등으로
            </div>
            <div className="introduce4" {...useScrollAnimation()}>
            <u>페어 프로그래밍</u> 기반 과제 진행과 2번의 협업 프로젝트를 진행했습니다.
            </div>
          </p>

          <p>
            <div className="introduce5" {...useScrollAnimation()}>
            모든 순간이 도전이고, 좌절하는 순간이 많겠지만
            
            지난날의 값진 경험을 토대로 끈질기게 붙잡아
            </div>
            <div className="introduce6" {...useScrollAnimation()}>
             끝끝내 최선의 웹 서비스를 구현해내는 개발자,

             항상 사용자가 오래 머무를 수 있도록
             </div>
             <div className="introduce7" {...useScrollAnimation()}>
